...
MINIMUM_KEYFRAME_PARALLAX_THRESHOLD = 0.45  # Minimum parallax for new keyframe
...
MINIMUM_NUMBER_OF_NEW_POINTS = 0.2
...
MINIMUM_TRIANGULATION_PARALLAX_THRESHOLD = 0.35
...
OUTLIER_GLOBAL_ERROR_THRESHOLD_FOR_POINTS = 2.0
